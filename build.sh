...
python3 - <<'PY'
tpl = open('web/node-page.html').read().replace('/*SCHEMATIC_JS*/', open('web/schematic.js').read())
assert ')HTML"' not in tpl
open('sonor-artnet-node/esp_page.h', 'w').write(
  '// GENERATED by build.sh from web/node-page.html + web/schematic.js — do not edit. Tokens (%NET% etc.) are filled in esp_node.h.\n'
  '#pragma once\nstatic const char PAGE[] PROGMEM = R"HTML(' + tpl + ')HTML";\n')
PY
